...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-6 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            @if(!$groups->isEmpty())
            <a href="{{ route('super-admin.teams.create') }}" class="btn btn-outline btn-success btn-sm">@lang('app.add') @lang('app.department') <i class="fa fa-plus" aria-hidden="true"></i></a>
            @endif
                                ...
                                <td>
                                    ...
                                    <div class="btn-group dropdown m-r-10">
                                        ...
                                        <ul role="menu" class="dropdown-menu pull-right">
                                            <li><a href="{{ route('super-admin.teams.edit', [$group->id]) }}"><i class="icon-settings"></i> @lang('app.manage')</a></li>
            ...
            $('body').on('click', '.sa-params', function(){
                ...
                swal({
                    ...
                    if (isConfirm) {
                        ...
                        var url = "{{ route('super-admin.teams.destroy',':id') }}";
